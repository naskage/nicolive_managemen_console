...
RSpec.describe "live_programs/edit", type: :view do
  before(:each) do
  ...
  it "renders the edit live_program form" do
    render

    assert_select "form[action=?][method=?]", live_program_path(@live_program), "post" do
